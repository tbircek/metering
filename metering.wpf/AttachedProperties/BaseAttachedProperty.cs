...
namespace metering
{
    ...
    /// <typeparam name="Property">The type of attached property</typeparam>
        ...
        where Parent: new()
    {
        ...
        /// <summary>
        /// The event fired when the value changes, even the value is same
        /// </summary>
        ...
        /// </summary>
        /// <param name="d">The element to set property for</param>
        ...
        /// <summary>
        /// The method that is called when any attached property of this type is changed, even if the value remain same
        /// </summary>
        /// <param name="sender">The UI element that this property</param>
