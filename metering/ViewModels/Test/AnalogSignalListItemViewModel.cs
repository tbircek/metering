namespace metering
{
    public class AnalogSignalListItemViewModel : BaseViewModel
    {
        ...
        ///// </summary>
        //public ObservableCollection<TestStepListViewModel> TestStep { get; set; }
        //#endregion
        ...
        //public TestStepListViewModel(string signalName, string from, string to, string delta, string phase, string frequency)
        //{
        ...
        //{
        //    TestStep = new ObservableCollection<TestStepListViewModel>();
